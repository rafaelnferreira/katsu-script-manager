...
declare -A CONFIG=( \
           ["WEBUI"]="service: calypso/collateral-webui                 version: 4.48.0-SNAPSHOT git_lab_token: $WEBUI_TOKEN            git_lab_url: https://gitlab.calypsoatlas.com/api/v4/projects/10/trigger/pipeline  project_folder: collateral-ui" \
      ["COLLATERAL"]="service: calypso/collateral-service               version: 7.35.0-SNAPSHOT git_lab_token: $COLLATERAL_TOKEN       git_lab_url: https://gitlab.calypsoatlas.com/api/v4/projects/7/trigger/pipeline   project_folder: collateral"  \
       ["STATEMENT"]="service: calypso/statement-service                version: 1.0.0           git_lab_token: $STATEMENT_TOKEN        git_lab_url: https://gitlab.calypsoatlas.com/api/v4/projects/11/trigger/pipeline  project_folder: statement" \
         ["REPORTS"]="service: calypso/collateral-reports-service       version: 2.16.0-SNAPSHOT git_lab_token: $REPORTS_TOKEN          git_lab_url: https://gitlab.calypsoatlas.com/api/v4/projects/13/trigger/pipeline  project_folder: collateral-reports" \
   ...
   ["NOTIFICATIONS"]="service: calypso/collateral-notifications-service version: 1.7.0-SNAPSHOT  git_lab_token: $NOTIFICATIONS_TOKEN    git_lab_url: https://gitlab.calypsoatlas.com/api/v4/projects/12/trigger/pipeline  project_folder: notifications" \
["USER-PREFERENCES"]="service: calypso/user-preferences-service         version: 1.0.0           git_lab_token: $USER_PREFERENCES_TOKEN git_lab_url: https://gitlab.calypsoatlas.com/api/v4/projects/43/trigger/pipeline  project_folder: user-preferences" \
          ["ACADIA"]="service: calypso/collateral-acadia-service        version: 3.7.0-SNAPSHOT  git_lab_token: $ACADIA_TOKEN           git_lab_url: https://gitlab.calypsoatlas.com/api/v4/projects/100/trigger/pipeline project_folder: collateral-acadia" \
	  ["INTEREST"]="service: calypso/collateral-interest-service    version: 0.2.0-SNAPSHOT  git_lab_token: $INTEREST_TOKEN         git_lab_url: https://gitlab.calypsoatlas.com/api/v4/projects/112/trigger/pipeline project_folder: collateral-interest" \
)
